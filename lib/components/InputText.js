    ...
    return (
      <View
        ...
        <View
          ...
          />
          {field.type === 'password' && this.renderShowPassword(field.iconColor)}
          {field.type !== 'password' && field.iconRight && (
            <FormIcon name={field.iconRight} size={iconSize} color={field.iconColor} />
          )}
        </View>
        {errors[field.name] && (
          <ErrorMessage
